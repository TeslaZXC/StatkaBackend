...
from routers import router_ocap_token
from routers import find_mission_router
...
app.include_router(find_mission_router.router, prefix="/api", tags=["поиск миссии"])
app.include_router(router_ocap_token.router, prefix="/api", tags=["ocap токены"])
